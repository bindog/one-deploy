...
c = consul.Consul(host='consulserver', port=8500)
...
NGINX_DYUPS_ADDR = "http://127.0.0.1:9901"
...
UPSTREAM_FILE = "/service/nginx/conf/dyups.consul.upstream.conf"
    ...
    for service_name in services_names:
        ...
        if service_nodes:
            for service in service_nodes:
                ...
                service_ip = service['Service']['Address']
